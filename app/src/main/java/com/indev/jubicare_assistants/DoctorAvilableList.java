...
public class DoctorAvilableList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor_avilable_list);
    ...
    private void callDoctorApi() {
        ...
        pharmacyPatientModel.setAvailability("available");
        Gson mGson = new Gson();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            Intent intent = new Intent(DoctorAvilableList.this, HomeActivity.class);
