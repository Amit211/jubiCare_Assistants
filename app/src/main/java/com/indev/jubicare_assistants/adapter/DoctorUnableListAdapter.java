...
public class DoctorUnableListAdapter extends RecyclerView.Adapter<DoctorUnableListAdapter.ViewHolder> {
    ...
    public DoctorUnableListAdapter(List<ContentValues> listModels, Context context) {
    ...
    @NonNull
    @Override
    public DoctorUnableListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_doctor_list, parent, false);
        DoctorUnableListAdapter.ViewHolder courseViewHolder = new DoctorUnableListAdapter.ViewHolder(view);
        return courseViewHolder;

    }

    @Override
    public void onBindViewHolder(@NonNull DoctorUnableListAdapter.ViewHolder holder, int position) {
