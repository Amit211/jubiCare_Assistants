...
import com.indev.jubicare_assistants.service.MyFirebaseMessagingService;
...
import static com.indev.jubicare_assistants.videocallingapp.IncomingCallScreenActivity.ACTION_ANSWER;
import static com.indev.jubicare_assistants.videocallingapp.IncomingCallScreenActivity.ACTION_IGNORE;
import static com.indev.jubicare_assistants.videocallingapp.IncomingCallScreenActivity.EXTRA_ID;
import static com.indev.jubicare_assistants.videocallingapp.IncomingCallScreenActivity.MESSAGE_ID;

public class SinchService extends Service {
    public static final String APP_KEY = "57312d3a-4bfd-4d40-95de-6aaefc83d8b4";
    public static final String APP_SECRET = "Js1rblNxUUSWteJ5WIKATw==";
    ...
    private class SinchCallClientListener implements CallClientListener {
        ...
        public void onIncomingCall(CallClient callClient, Call call) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && !inForeground) {

                Intent svc=new Intent(SinchService.this, BackgroundSoundService.class);
                startService(svc);
        ...
        private Notification createIncomingCallNotification(String userId, Intent fullScreenIntent) {
            final Uri alarmSound = Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE
                    + "://" + getApplicationContext().getPackageName() + "/raw/got_it_done.mp3");
            ...
            NotificationCompat.Builder builder =
                    new NotificationCompat.Builder(getApplicationContext(), MyFirebaseMessagingService.CHANNEL_ID)
                            .setContentTitle("Incoming call")
                            .setContentText(userId)
                            .setLargeIcon(getBitmap(getApplicationContext(), R.drawable.ic_call_black_24dp))
                            .setSmallIcon(R.drawable.app_icon)
                            .setPriority(NotificationCompat.PRIORITY_MAX)
                            .setContentIntent(pendingIntent)
                            .setSound(alarmSound)
                            .setFullScreenIntent(pendingIntent, true)
                            .addAction(R.drawable.ic_call_black_24dp, "Answer",  getPendingIntent(fullScreenIntent, ACTION_ANSWER))
                            .addAction(R.drawable.ic_call_black_24dp, "Ignore", getPendingIntent(fullScreenIntent, ACTION_IGNORE))
                            .setOngoing(true);
